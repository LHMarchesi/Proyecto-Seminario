...
public class MeleeBossAttack : BossAttackStats
{
    public override void Execute(BossEnemy boss, Transform target, HandleAnimations animations)
    {
        ...
        boss.PrepareAttack(damage, knockbackHorizontal, knockbackVertical);
        boss.DoMeleeAttack(damage, attackDelay, attackDuration, knockbackHorizontal, knockbackVertical);
